...
У останній версії першої лабораторної Admin не створюється в тесті як звичайний користувач, а має існувати після розгортання БД через `sql/add_start_data.sql`:
